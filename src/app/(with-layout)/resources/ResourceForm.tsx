...
const empty = {
  ...
  isCrypto: false,
  chain: "",
  // 30 дней, а не «1 месяц»: для месячной стоимости это одно и то же, но дату
  // следующей оплаты они двигают по-разному. Календарный месяц с 31 января
  // уедет на 28 февраля, а 30 дней — всегда ровно 30. Большинство хостингов
  // считает именно сутками, поэтому по умолчанию так.
  periodValue: "30",
  periodUnit: "DAY",
  nextPaymentAt: "",
  providerId: "",
