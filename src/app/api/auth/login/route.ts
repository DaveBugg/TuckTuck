...
// Пять попыток с адреса за пять минут и десять на логин за пятнадцать. Разные
// окна намеренно: один адрес за общим NAT — это несколько человек, а вот
// долбёжка в один логин почти всегда перебор.
const IP_LIMIT = 5;
